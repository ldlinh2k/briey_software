...
// Date      : 06/09/2022, 10:26:50
// Component : Briey

`include "/home/linh/KLTN/VexRiscv/src/main/scala/vexriscv/periph/Verilog_code/aes/aes.v"
...
`include "/home/linh/KLTN/VexRiscv/src/main/scala/vexriscv/periph/Verilog_code/present/present.v"
	
	
`include "/home/linh/KLTN/VexRiscv/src/main/scala/vexriscv/periph/Verilog_code/chacha/chacha.v"
`include "/home/linh/KLTN/VexRiscv/src/main/scala/vexriscv/periph/Verilog_code/chacha/chacha_core.v"
`include "/home/linh/KLTN/VexRiscv/src/main/scala/vexriscv/periph/Verilog_code/chacha/chacha_qr.v"

`include "/home/linh/KLTN/VexRiscv/src/main/scala/vexriscv/periph/Verilog_code/poly1305/poly1305_core.v"
`include "/home/linh/KLTN/VexRiscv/src/main/scala/vexriscv/periph/Verilog_code/poly1305/poly1305_final.v"
`include "/home/linh/KLTN/VexRiscv/src/main/scala/vexriscv/periph/Verilog_code/poly1305/poly1305_mulacc.v"
`include "/home/linh/KLTN/VexRiscv/src/main/scala/vexriscv/periph/Verilog_code/poly1305/poly1305_pblock.v"
`include "/home/linh/KLTN/VexRiscv/src/main/scala/vexriscv/periph/Verilog_code/poly1305/poly1305.v"
...
module Apb3ChachaCtrl (
      ...
      input   toplevel_resetCtrl_axiReset,
      input   toplevel_io_axiClk);
  wire [31:0] chacha_module_read_data;
  wire [0:0] _zz_1_;
  wire [0:0] _zz_2_;
  wire  apbCtrl_askWrite;
  wire  apbCtrl_askRead;
  wire  apbCtrl_doWrite;
  wire  apbCtrl_doRead;
  reg  chacha_module_cs_driver;
  reg  chacha_module_we_driver;
  reg [7:0] chacha_module_addr_driver;
  reg [31:0] chacha_module_write_data_driver;
  assign _zz_1_ = io_apb_PWDATA[0 : 0];
  assign _zz_2_ = io_apb_PWDATA[0 : 0];
  chacha chacha_module ( 
    .clk(toplevel_io_axiClk),
    .reset(toplevel_resetCtrl_axiReset),
    .cs(chacha_module_cs_driver),
    .we(chacha_module_we_driver),
    .addr(chacha_module_addr_driver),
    .write_data(chacha_module_write_data_driver),
    .read_data(chacha_module_read_data) 
  );
  assign io_apb_PREADY = 1'b1;
  always @ (*) begin
    io_apb_PRDATA = (32'b00000000000000000000000000000000);
    case(io_apb_PADDR)
      5'b00000 : begin
        io_apb_PRDATA[0 : 0] = chacha_module_cs_driver;
      end
      5'b00100 : begin
        io_apb_PRDATA[0 : 0] = chacha_module_we_driver;
      end
      5'b01000 : begin
        io_apb_PRDATA[7 : 0] = chacha_module_addr_driver;
      end
      5'b01100 : begin
        io_apb_PRDATA[31 : 0] = chacha_module_write_data_driver;
      end
      5'b10000 : begin
        io_apb_PRDATA[31 : 0] = chacha_module_read_data;
      end
      default : begin
      end
    endcase
  ...
  always @ (posedge toplevel_io_axiClk) begin
    case(io_apb_PADDR)
      5'b00000 : begin
        if(apbCtrl_doWrite)begin
          chacha_module_cs_driver <= _zz_1_[0];
        end
      end
      5'b00100 : begin
        if(apbCtrl_doWrite)begin
          chacha_module_we_driver <= _zz_2_[0];
        end
      end
      5'b01000 : begin
        if(apbCtrl_doWrite)begin
          chacha_module_addr_driver <= io_apb_PWDATA[7 : 0];
        end
      end
      5'b01100 : begin
        if(apbCtrl_doWrite)begin
          chacha_module_write_data_driver <= io_apb_PWDATA[31 : 0];
        end
      end
      5'b10000 : begin
      end
...
module Apb3Poly1305Ctrl (
      ...
      input   toplevel_resetCtrl_axiReset,
      input   toplevel_io_axiClk);
  wire [31:0] poly1305_module_read_data;
  wire [0:0] _zz_1_;
  wire [0:0] _zz_2_;
  wire  apbCtrl_askWrite;
  wire  apbCtrl_askRead;
  wire  apbCtrl_doWrite;
  wire  apbCtrl_doRead;
  reg  poly1305_module_cs_driver;
  reg  poly1305_module_we_driver;
  reg [7:0] poly1305_module_address_driver;
  reg [31:0] poly1305_module_write_data_driver;
  assign _zz_1_ = io_apb_PWDATA[0 : 0];
  assign _zz_2_ = io_apb_PWDATA[0 : 0];
  poly1305 poly1305_module ( 
    .clk(toplevel_io_axiClk),
    .reset(toplevel_resetCtrl_axiReset),
    .cs(poly1305_module_cs_driver),
    .we(poly1305_module_we_driver),
    .address(poly1305_module_address_driver),
    .write_data(poly1305_module_write_data_driver),
    .read_data(poly1305_module_read_data) 
  );
  assign io_apb_PREADY = 1'b1;
  always @ (*) begin
    io_apb_PRDATA = (32'b00000000000000000000000000000000);
    case(io_apb_PADDR)
      5'b00000 : begin
        io_apb_PRDATA[0 : 0] = poly1305_module_cs_driver;
      end
      5'b00100 : begin
        io_apb_PRDATA[0 : 0] = poly1305_module_we_driver;
      end
      5'b01000 : begin
        io_apb_PRDATA[7 : 0] = poly1305_module_address_driver;
      end
      5'b01100 : begin
        io_apb_PRDATA[31 : 0] = poly1305_module_write_data_driver;
      end
      5'b10000 : begin
        io_apb_PRDATA[31 : 0] = poly1305_module_read_data;
      end
      default : begin
      end
    endcase
  ...
  always @ (posedge toplevel_io_axiClk) begin
    case(io_apb_PADDR)
      5'b00000 : begin
        if(apbCtrl_doWrite)begin
          poly1305_module_cs_driver <= _zz_1_[0];
        end
      end
      5'b00100 : begin
        if(apbCtrl_doWrite)begin
          poly1305_module_we_driver <= _zz_2_[0];
        end
      end
      5'b01000 : begin
        if(apbCtrl_doWrite)begin
          poly1305_module_address_driver <= io_apb_PWDATA[7 : 0];
        end
      end
      5'b01100 : begin
        if(apbCtrl_doWrite)begin
          poly1305_module_write_data_driver <= io_apb_PWDATA[31 : 0];
        end
      end
      5'b10000 : begin
      end
...
module VexRiscv (
  ...
  wire `ShiftCtrlEnum_defaultEncoding_type _zz_144_;
  ...
  assign _zz_251_ = _zz_137_[2 : 2];
  assign _zz_252_ = _zz_137_[5 : 5];
  assign _zz_253_ = _zz_137_[6 : 6];
  assign _zz_254_ = _zz_137_[7 : 7];
  assign _zz_255_ = _zz_137_[8 : 8];
  assign _zz_256_ = _zz_137_[9 : 9];
  assign _zz_257_ = _zz_137_[10 : 10];
  assign _zz_258_ = _zz_137_[11 : 11];
  assign _zz_259_ = _zz_137_[12 : 12];
  assign _zz_260_ = _zz_137_[13 : 13];
  assign _zz_261_ = _zz_137_[14 : 14];
  assign _zz_262_ = _zz_137_[19 : 19];
  assign _zz_263_ = _zz_137_[24 : 24];
  assign _zz_264_ = _zz_137_[25 : 25];
  assign _zz_265_ = _zz_137_[26 : 26];
  ...
  assign _zz_335_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000010100)) == (32'b00000000000000000000000000000100));
  assign _zz_336_ = ((decode_INSTRUCTION & (32'b00000000000000000000000001000100)) == (32'b00000000000000000000000000000100));
  assign _zz_337_ = _zz_141_;
  assign _zz_338_ = ((decode_INSTRUCTION & (32'b00000000000000000001000000000000)) == (32'b00000000000000000001000000000000));
  assign _zz_339_ = (1'b0);
  assign _zz_340_ = (((decode_INSTRUCTION & _zz_343_) == (32'b00000000000000000010000000000000)) != (1'b0));
  assign _zz_341_ = (_zz_138_ != (1'b0));
  assign _zz_342_ = {({_zz_344_,_zz_345_} != (5'b00000)),{(_zz_346_ != _zz_347_),{_zz_348_,{_zz_349_,_zz_350_}}}};
  assign _zz_343_ = (32'b00000000000000000011000000000000);
  assign _zz_344_ = _zz_140_;
  assign _zz_345_ = {(_zz_351_ == _zz_352_),{_zz_353_,{_zz_354_,_zz_355_}}};
  assign _zz_346_ = ((decode_INSTRUCTION & _zz_356_) == (32'b00000000000000000000000000100100));
  assign _zz_347_ = (1'b0);
  assign _zz_348_ = ({_zz_139_,_zz_357_} != (2'b00));
  assign _zz_349_ = (_zz_358_ != (1'b0));
  assign _zz_350_ = {(_zz_359_ != _zz_360_),{_zz_361_,{_zz_362_,_zz_363_}}};
  assign _zz_351_ = (decode_INSTRUCTION & (32'b00000000000000000010000000110000));
  assign _zz_352_ = (32'b00000000000000000010000000010000);
  assign _zz_353_ = ((decode_INSTRUCTION & (32'b00000000000000000001000000110000)) == (32'b00000000000000000000000000010000));
  assign _zz_354_ = ((decode_INSTRUCTION & _zz_364_) == (32'b00000000000000000010000000100000));
  assign _zz_355_ = ((decode_INSTRUCTION & _zz_365_) == (32'b00000000000000000000000000100000));
  assign _zz_356_ = (32'b00000000000000000000000001100100);
  ...
  assign _zz_359_ = ((decode_INSTRUCTION & _zz_366_) == (32'b00000000000000000000000001010000));
  assign _zz_360_ = (1'b0);
  assign _zz_361_ = ({_zz_367_,{_zz_368_,_zz_369_}} != (3'b000));
  assign _zz_362_ = ({_zz_370_,_zz_371_} != (4'b0000));
  assign _zz_363_ = {(_zz_372_ != _zz_373_),{_zz_374_,{_zz_375_,_zz_376_}}};
  assign _zz_364_ = (32'b00000010000000000010000001100000);
  assign _zz_365_ = (32'b00000010000000000011000000100000);
  assign _zz_366_ = (32'b00000000000100000011000001010000);
  assign _zz_367_ = ((decode_INSTRUCTION & _zz_377_) == (32'b00000000000000000000000001000000));
  assign _zz_368_ = (_zz_378_ == _zz_379_);
  assign _zz_369_ = (_zz_380_ == _zz_381_);
  assign _zz_370_ = (_zz_382_ == _zz_383_);
  assign _zz_371_ = {_zz_384_,{_zz_385_,_zz_386_}};
  assign _zz_372_ = {_zz_387_,_zz_388_};
  assign _zz_373_ = (2'b00);
  assign _zz_374_ = ({_zz_389_,_zz_390_} != (3'b000));
  assign _zz_375_ = (_zz_391_ != _zz_392_);
  assign _zz_376_ = {_zz_393_,{_zz_394_,_zz_395_}};
  assign _zz_377_ = (32'b00000000000000000000000001010000);
  assign _zz_378_ = (decode_INSTRUCTION & (32'b00000000000000000000000000111000));
  assign _zz_379_ = (32'b00000000000000000000000000000000);
  assign _zz_380_ = (decode_INSTRUCTION & (32'b00000000000100000011000001000000));
  assign _zz_381_ = (32'b00000000000000000000000001000000);
  assign _zz_382_ = (decode_INSTRUCTION & (32'b00000000000000000000000001000100));
  assign _zz_383_ = (32'b00000000000000000000000000000000);
  assign _zz_384_ = ((decode_INSTRUCTION & _zz_396_) == (32'b00000000000000000000000000000000));
  assign _zz_385_ = (_zz_397_ == _zz_398_);
  assign _zz_386_ = (_zz_399_ == _zz_400_);
  assign _zz_387_ = ((decode_INSTRUCTION & _zz_401_) == (32'b00000000000000000101000000010000));
  assign _zz_388_ = ((decode_INSTRUCTION & _zz_402_) == (32'b00000000000000000101000000100000));
  assign _zz_389_ = (_zz_403_ == _zz_404_);
  assign _zz_390_ = {_zz_405_,_zz_406_};
  assign _zz_391_ = {_zz_140_,_zz_407_};
  ...
  assign _zz_396_ = (32'b00000000000000000000000000011000);
  assign _zz_397_ = (decode_INSTRUCTION & (32'b00000000000000000110000000000100));
  assign _zz_398_ = (32'b00000000000000000010000000000000);
  assign _zz_399_ = (decode_INSTRUCTION & (32'b00000000000000000101000000000100));
  assign _zz_400_ = (32'b00000000000000000001000000000000);
  ...
  assign _zz_414_ = {(_zz_424_ != _zz_425_),{_zz_426_,{_zz_427_,_zz_428_}}};
  assign _zz_415_ = (32'b00000000000000000000000000100000);
  assign _zz_416_ = (decode_INSTRUCTION & (32'b00000000000000000010000000010000));
  assign _zz_417_ = (32'b00000000000000000010000000000000);
  assign _zz_418_ = (decode_INSTRUCTION & (32'b00000000000000000101000000000000));
  assign _zz_419_ = (32'b00000000000000000001000000000000);
  assign _zz_420_ = (decode_INSTRUCTION & (32'b00000010000000000100000001110100));
  assign _zz_421_ = (32'b00000010000000000000000000110000);
  assign _zz_422_ = ((decode_INSTRUCTION & _zz_429_) == (32'b00000000000000000001000001010000));
  assign _zz_423_ = ((decode_INSTRUCTION & _zz_430_) == (32'b00000000000000000010000001010000));
  assign _zz_424_ = {(_zz_431_ == _zz_432_),{_zz_140_,{_zz_433_,_zz_434_}}};
  assign _zz_425_ = (5'b00000);
  assign _zz_426_ = ((_zz_435_ == _zz_436_) != (1'b0));
  assign _zz_427_ = (_zz_437_ != (1'b0));
  assign _zz_428_ = {(_zz_438_ != _zz_439_),{_zz_440_,{_zz_441_,_zz_442_}}};
  assign _zz_429_ = (32'b00000000000000000001000001010000);
  assign _zz_430_ = (32'b00000000000000000010000001010000);
  assign _zz_431_ = (decode_INSTRUCTION & (32'b00000000000000000000000001000000));
  assign _zz_432_ = (32'b00000000000000000000000001000000);
  assign _zz_433_ = ((decode_INSTRUCTION & _zz_443_) == (32'b00000000000000000100000000100000));
  assign _zz_434_ = {(_zz_444_ == _zz_445_),(_zz_446_ == _zz_447_)};
  assign _zz_435_ = (decode_INSTRUCTION & (32'b00000000000000000000000001011000));
  assign _zz_436_ = (32'b00000000000000000000000000000000);
  assign _zz_437_ = ((decode_INSTRUCTION & (32'b00000000000000000100000001001000)) == (32'b00000000000000000100000000001000));
  assign _zz_438_ = {(_zz_448_ == _zz_449_),(_zz_450_ == _zz_451_)};
  assign _zz_439_ = (2'b00);
  assign _zz_440_ = ({_zz_139_,{_zz_452_,_zz_453_}} != (6'b000000));
  assign _zz_441_ = (_zz_454_ != (1'b0));
  assign _zz_442_ = {(_zz_455_ != _zz_456_),{_zz_457_,{_zz_458_,_zz_459_}}};
  ...
  assign _zz_446_ = (decode_INSTRUCTION & (32'b00000010000000000000000000100000));
  assign _zz_447_ = (32'b00000000000000000000000000100000);
  assign _zz_448_ = (decode_INSTRUCTION & (32'b00000000000000000000000000110100));
  assign _zz_449_ = (32'b00000000000000000000000000100000);
  assign _zz_450_ = (decode_INSTRUCTION & (32'b00000000000000000000000001100100));
  assign _zz_451_ = (32'b00000000000000000000000000100000);
  assign _zz_452_ = ((decode_INSTRUCTION & _zz_460_) == (32'b00000000000000000001000000010000));
  assign _zz_453_ = {(_zz_461_ == _zz_462_),{_zz_463_,{_zz_464_,_zz_465_}}};
  assign _zz_454_ = ((decode_INSTRUCTION & (32'b00010000000000000011000001010000)) == (32'b00000000000000000000000001010000));
  assign _zz_455_ = _zz_138_;
  assign _zz_456_ = (1'b0);
  assign _zz_457_ = ((_zz_466_ == _zz_467_) != (1'b0));
  assign _zz_458_ = (_zz_468_ != (1'b0));
  assign _zz_459_ = {(_zz_469_ != _zz_470_),{_zz_471_,_zz_472_}};
  assign _zz_460_ = (32'b00000000000000000001000000010000);
  assign _zz_461_ = (decode_INSTRUCTION & (32'b00000000000000000010000000010000));
  assign _zz_462_ = (32'b00000000000000000010000000010000);
  assign _zz_463_ = ((decode_INSTRUCTION & (32'b00000000000000000000000001010000)) == (32'b00000000000000000000000000010000));
  assign _zz_464_ = ((decode_INSTRUCTION & _zz_473_) == (32'b00000000000000000000000000000100));
  assign _zz_465_ = ((decode_INSTRUCTION & _zz_474_) == (32'b00000000000000000000000000000000));
  assign _zz_466_ = (decode_INSTRUCTION & (32'b00000000000000000100000000010100));
  assign _zz_467_ = (32'b00000000000000000100000000010000);
  assign _zz_468_ = ((decode_INSTRUCTION & (32'b00000000000000000110000000010100)) == (32'b00000000000000000010000000010000));
  assign _zz_469_ = {(_zz_475_ == _zz_476_),{_zz_477_,_zz_478_}};
  assign _zz_470_ = (3'b000);
  assign _zz_471_ = ((_zz_479_ == _zz_480_) != (1'b0));
  assign _zz_472_ = ((_zz_481_ == _zz_482_) != (1'b0));
  assign _zz_473_ = (32'b00000000000000000000000000001100);
  assign _zz_474_ = (32'b00000000000000000000000000101000);
  ...
  assign _zz_481_ = (decode_INSTRUCTION & (32'b00000000000000000101000001001000));
  assign _zz_482_ = (32'b00000000000000000001000000001000);
  assign _zz_483_ = (32'b00000000000000000001000001111111);
  assign _zz_484_ = (decode_INSTRUCTION & (32'b00000000000000000010000001111111));
  assign _zz_485_ = (32'b00000000000000000010000001110011);
  assign _zz_486_ = ((decode_INSTRUCTION & (32'b00000000000000000100000001111111)) == (32'b00000000000000000100000001100011));
  assign _zz_487_ = ((decode_INSTRUCTION & (32'b00000000000000000010000001111111)) == (32'b00000000000000000010000000010011));
  assign _zz_488_ = {((decode_INSTRUCTION & (32'b00000000000000000110000000111111)) == (32'b00000000000000000000000000100011)),{((decode_INSTRUCTION & (32'b00000000000000000010000001111111)) == (32'b00000000000000000000000000000011)),{((decode_INSTRUCTION & _zz_489_) == (32'b00000000000000000000000000000011)),{(_zz_490_ == _zz_491_),{_zz_492_,{_zz_493_,_zz_494_}}}}}};
  assign _zz_489_ = (32'b00000000000000000101000001011111);
  assign _zz_490_ = (decode_INSTRUCTION & (32'b00000000000000000111000001111011));
  assign _zz_491_ = (32'b00000000000000000000000001100011);
  assign _zz_492_ = ((decode_INSTRUCTION & (32'b00000000000000000110000001111111)) == (32'b00000000000000000000000000001111));
  assign _zz_493_ = ((decode_INSTRUCTION & (32'b11111100000000000000000001111111)) == (32'b00000000000000000000000000110011));
  assign _zz_494_ = {((decode_INSTRUCTION & (32'b00000001111100000111000001111111)) == (32'b00000000000000000101000000001111)),{((decode_INSTRUCTION & (32'b10111100000000000111000001111111)) == (32'b00000000000000000101000000010011)),{((decode_INSTRUCTION & _zz_495_) == (32'b00000000000000000001000000010011)),{(_zz_496_ == _zz_497_),{_zz_498_,{_zz_499_,_zz_500_}}}}}};
  assign _zz_495_ = (32'b11111100000000000011000001111111);
  assign _zz_496_ = (decode_INSTRUCTION & (32'b10111110000000000111000001111111));
  assign _zz_497_ = (32'b00000000000000000101000000110011);
  assign _zz_498_ = ((decode_INSTRUCTION & (32'b10111110000000000111000001111111)) == (32'b00000000000000000000000000110011));
  assign _zz_499_ = ((decode_INSTRUCTION & (32'b11011111111111111111111111111111)) == (32'b00010000001000000000000001110011));
  assign _zz_500_ = ((decode_INSTRUCTION & (32'b11111111111111111111111111111111)) == (32'b00000000000100000000000001110011));
  ...
  always @(*) begin
    case(_zz_144_)
      `ShiftCtrlEnum_defaultEncoding_DISABLE_1 : _zz_144__string = "DISABLE_1";
      `ShiftCtrlEnum_defaultEncoding_SLL_1 : _zz_144__string = "SLL_1    ";
      `ShiftCtrlEnum_defaultEncoding_SRL_1 : _zz_144__string = "SRL_1    ";
      `ShiftCtrlEnum_defaultEncoding_SRA_1 : _zz_144__string = "SRA_1    ";
  ...
  assign decode_IS_EBREAK = _zz_84_;
  ...
  assign _zz_137_ = {(((decode_INSTRUCTION & _zz_334_) == (32'b00000000000000000000000000100000)) != (1'b0)),{({_zz_335_,_zz_141_} != (2'b00)),{({_zz_336_,_zz_337_} != (2'b00)),{(_zz_338_ != _zz_339_),{_zz_340_,{_zz_341_,_zz_342_}}}}}};
  assign _zz_90_ = ({((decode_INSTRUCTION & (32'b00000000000000000000000001011111)) == (32'b00000000000000000000000000010111)),{((decode_INSTRUCTION & (32'b00000000000000000000000001111111)) == (32'b00000000000000000000000001101111)),{((decode_INSTRUCTION & (32'b00000000000000000001000001101111)) == (32'b00000000000000000000000000000011)),{((decode_INSTRUCTION & _zz_483_) == (32'b00000000000000000001000001110011)),{(_zz_484_ == _zz_485_),{_zz_486_,{_zz_487_,_zz_488_}}}}}}} != (20'b00000000000000000000));
  assign _zz_89_ = _zz_249_[0];
  assign _zz_88_ = _zz_250_[0];
  assign _zz_87_ = _zz_251_[0];
  ...
  always @ (*) begin
    case(execute_BRANCH_CTRL)
      ...
      default : begin
        ...
        execute_BranchPlugin_branch_src2 = ((execute_BRANCH_CTRL == `BranchCtrlEnum_defaultEncoding_JAL) ? {{_zz_191_,{{{_zz_501_,execute_INSTRUCTION[19 : 12]},execute_INSTRUCTION[20]},execute_INSTRUCTION[30 : 21]}},1'b0} : {{_zz_193_,{{{_zz_502_,_zz_503_},execute_INSTRUCTION[30 : 25]},execute_INSTRUCTION[11 : 8]}},1'b0});
...
module Apb3Decoder (
  ...
  always @ (*) begin
    ...
    io_output_PSEL[3] = ((((20'b00000010010000000000) <= io_input_PADDR) && (io_input_PADDR < (20'b00000010110000000000))) && io_input_PSEL[0]);
    io_output_PSEL[4] = (((io_input_PADDR & _zz_4_) == (20'b00000010110000000000)) && io_input_PSEL[0]);
    io_output_PSEL[5] = (((io_input_PADDR & _zz_5_) == (20'b00000011000000000000)) && io_input_PSEL[0]);
    io_output_PSEL[6] = (((io_input_PADDR & _zz_6_) == (20'b00000011010000000000)) && io_input_PSEL[0]);
    io_output_PSEL[7] = (((io_input_PADDR & _zz_7_) == (20'b00010000000000000000)) && io_input_PSEL[0]);
    io_output_PSEL[8] = (((io_input_PADDR & _zz_8_) == (20'b00100000000000000000)) && io_input_PSEL[0]);
    io_output_PSEL[9] = (((io_input_PADDR & _zz_9_) == (20'b00110000000000000000)) && io_input_PSEL[0]);
  end
...
module Apb3Router (
  ...
  always @(*) begin
    case(selIndex)
      4'b0000 : begin
        _zz_10_ = io_outputs_0_PREADY;
        _zz_11_ = io_outputs_0_PRDATA;
        _zz_12_ = io_outputs_0_PSLVERROR;
      end
      4'b0001 : begin
        _zz_10_ = io_outputs_1_PREADY;
        _zz_11_ = io_outputs_1_PRDATA;
        _zz_12_ = io_outputs_1_PSLVERROR;
      end
      4'b0010 : begin
        _zz_10_ = io_outputs_2_PREADY;
        _zz_11_ = io_outputs_2_PRDATA;
        _zz_12_ = io_outputs_2_PSLVERROR;
      end
      4'b0011 : begin
        _zz_10_ = io_outputs_3_PREADY;
        _zz_11_ = io_outputs_3_PRDATA;
        _zz_12_ = io_outputs_3_PSLVERROR;
      end
      4'b0100 : begin
        _zz_10_ = io_outputs_4_PREADY;
        _zz_11_ = io_outputs_4_PRDATA;
        _zz_12_ = io_outputs_4_PSLVERROR;
      end
      4'b0101 : begin
        _zz_10_ = io_outputs_5_PREADY;
        _zz_11_ = io_outputs_5_PRDATA;
        _zz_12_ = io_outputs_5_PSLVERROR;
      end
      4'b0110 : begin
        _zz_10_ = io_outputs_6_PREADY;
        _zz_11_ = io_outputs_6_PRDATA;
        _zz_12_ = io_outputs_6_PSLVERROR;
      end
      4'b0111 : begin
        _zz_10_ = io_outputs_7_PREADY;
        _zz_11_ = io_outputs_7_PRDATA;
        _zz_12_ = io_outputs_7_PSLVERROR;
      end
      4'b1000 : begin
        _zz_10_ = io_outputs_8_PREADY;
        _zz_11_ = io_outputs_8_PRDATA;
        _zz_12_ = io_outputs_8_PSLVERROR;
      end
      default : begin
        _zz_10_ = io_outputs_9_PREADY;
        _zz_11_ = io_outputs_9_PRDATA;
        _zz_12_ = io_outputs_9_PSLVERROR;
      end
    endcase
  end
  ...
  assign _zz_6_ = ((((io_input_PSEL[1] || _zz_1_) || _zz_2_) || _zz_4_) || _zz_5_);
  assign _zz_7_ = (((io_input_PSEL[2] || _zz_1_) || _zz_3_) || _zz_4_);
  assign _zz_8_ = (((io_input_PSEL[4] || _zz_2_) || _zz_3_) || _zz_4_);
  assign _zz_9_ = (io_input_PSEL[8] || _zz_5_);
  assign io_input_PREADY = _zz_10_;
  assign io_input_PRDATA = _zz_11_;
  assign io_input_PSLVERROR = _zz_12_;
  always @ (posedge toplevel_io_axiClk) begin
    selIndex <= {_zz_9_,{_zz_8_,{_zz_7_,_zz_6_}}};
  end
...
module Briey (
  ...
  wire  axi_apbChachaBridge_io_apb_PREADY;
  wire [31:0] axi_apbChachaBridge_io_apb_PRDATA;
  wire  axi_apbPoly1305Bridge_io_apb_PREADY;
  wire [31:0] axi_apbPoly1305Bridge_io_apb_PRDATA;
  ...
  assign _zz_127_ = (resetCtrl_systemResetCounter != _zz_1_);
  assign _zz_128_ = (axi_core_cpu_dBus_cmd_m2sPipe_m2sPipe_ready && (! axi_core_cpu_dBus_cmd_m2sPipe_m2sPipe_s2mPipe_ready));
  assign _zz_129_ = (! axi_vgaCtrl_io_axi_ar_halfPipe_regs_valid);
  assign _zz_130_ = (! axi_ram_io_axi_arbiter_io_output_arw_halfPipe_regs_valid);
  assign _zz_131_ = (_zz_110_ && (! axi_ram_io_axi_arbiter_io_output_w_s2mPipe_ready));
  assign _zz_132_ = (! axi_sdramCtrl_io_axi_arbiter_io_output_arw_halfPipe_regs_valid);
  assign _zz_133_ = (_zz_117_ && (! axi_sdramCtrl_io_axi_arbiter_io_output_w_s2mPipe_ready));
  assign _zz_134_ = (! axi_apbBridge_io_axi_arbiter_io_output_arw_halfPipe_regs_valid);
  assign _zz_135_ = (! axi_apbBridge_io_axi_arbiter_io_output_w_halfPipe_regs_valid);
  ...
  VexRiscv axi_core_cpu ( 
    ...
    .debug_bus_cmd_payload_address(_zz_92_),
    ...
    .iBus_rsp_payload_error(_zz_93_),
    .dBus_cmd_valid(axi_core_cpu_dBus_cmd_valid),
    .dBus_cmd_ready(_zz_94_),
  ...
  Axi4ReadOnlyDecoder axi_core_iBus_decoder ( 
    ...
    .io_outputs_1_ar_ready(_zz_100_),
  ...
  Axi4SharedDecoder axi_core_dBus_decoder ( 
    ...
    .io_sharedOutputs_0_arw_ready(_zz_102_),
    ...
    .io_sharedOutputs_1_arw_ready(_zz_103_),
    ...
    .io_sharedOutputs_2_arw_ready(_zz_104_),
  ...
  Axi4ReadOnlyDecoder_1_ axi_vgaCtrl_io_axi_decoder ( 
    ...
    .io_outputs_0_ar_ready(_zz_105_),
  ...
  Axi4SharedArbiter_1_ axi_sdramCtrl_io_axi_arbiter ( 
    ...
    .io_readInputs_1_ar_payload_addr(_zz_113_),
    ...
    .io_readInputs_1_ar_payload_burst(_zz_114_),
    ...
    .io_sharedInputs_0_arw_payload_addr(_zz_115_),
    ...
    .io_sharedInputs_0_arw_payload_burst(_zz_116_),
  ...
  Axi4SharedArbiter_2_ axi_apbBridge_io_axi_arbiter ( 
    ...
    .io_sharedInputs_0_arw_payload_addr(_zz_118_),
    ...
    .io_sharedInputs_0_arw_payload_burst(_zz_119_),
  ...
  Apb3Router apb3Router_1_ ( 
    ...
    .io_outputs_2_PSLVERROR(_zz_120_),
    ...
    .io_outputs_3_PREADY(axi_apbPresentBridge_io_apb_PREADY),
    .io_outputs_3_PWRITE(apb3Router_1__io_outputs_3_PWRITE),
    .io_outputs_3_PWDATA(apb3Router_1__io_outputs_3_PWDATA),
    .io_outputs_3_PRDATA(axi_apbPresentBridge_io_apb_PRDATA),
    .io_outputs_3_PSLVERROR(_zz_121_),
    ...
    .io_outputs_4_PREADY(axi_apbChachaBridge_io_apb_PREADY),
    .io_outputs_4_PWRITE(apb3Router_1__io_outputs_4_PWRITE),
    .io_outputs_4_PWDATA(apb3Router_1__io_outputs_4_PWDATA),
    .io_outputs_4_PRDATA(axi_apbChachaBridge_io_apb_PRDATA),
    .io_outputs_4_PSLVERROR(_zz_122_),
    ...
    .io_outputs_5_PREADY(axi_apbPoly1305Bridge_io_apb_PREADY),
    .io_outputs_5_PWRITE(apb3Router_1__io_outputs_5_PWRITE),
    .io_outputs_5_PWDATA(apb3Router_1__io_outputs_5_PWDATA),
    .io_outputs_5_PRDATA(axi_apbPoly1305Bridge_io_apb_PRDATA),
    .io_outputs_5_PSLVERROR(_zz_123_),
    ...
    .io_outputs_6_PREADY(axi_apbAESBridge_io_apb_PREADY),
    .io_outputs_6_PWRITE(apb3Router_1__io_outputs_6_PWRITE),
    .io_outputs_6_PWDATA(apb3Router_1__io_outputs_6_PWDATA),
    .io_outputs_6_PRDATA(axi_apbAESBridge_io_apb_PRDATA),
    .io_outputs_6_PSLVERROR(_zz_124_),
    ...
    .io_outputs_7_PREADY(axi_uartCtrl_io_apb_PREADY),
    .io_outputs_7_PWRITE(apb3Router_1__io_outputs_7_PWRITE),
    .io_outputs_7_PWDATA(apb3Router_1__io_outputs_7_PWDATA),
    .io_outputs_7_PRDATA(axi_uartCtrl_io_apb_PRDATA),
    .io_outputs_7_PSLVERROR(_zz_125_),
    ...
    .io_outputs_8_PREADY(axi_timerCtrl_io_apb_PREADY),
    .io_outputs_8_PWRITE(apb3Router_1__io_outputs_8_PWRITE),
    .io_outputs_8_PWDATA(apb3Router_1__io_outputs_8_PWDATA),
    .io_outputs_8_PRDATA(axi_timerCtrl_io_apb_PRDATA),
    .io_outputs_8_PSLVERROR(axi_timerCtrl_io_apb_PSLVERROR),
    ...
    .io_outputs_9_PREADY(axi_vgaCtrl_io_apb_PREADY),
    .io_outputs_9_PWRITE(apb3Router_1__io_outputs_9_PWRITE),
    .io_outputs_9_PWDATA(apb3Router_1__io_outputs_9_PWDATA),
    .io_outputs_9_PRDATA(axi_vgaCtrl_io_apb_PRDATA),
    .io_outputs_9_PSLVERROR(_zz_126_),
    .toplevel_io_axiClk(io_axiClk),
    .toplevel_resetCtrl_axiReset(resetCtrl_axiReset) 
  );
  always @ (*) begin
  ...
  assign _zz_93_ = (! (axi_core_iBus_r_payload_resp == (2'b00)));
  ...
  assign _zz_94_ = ((1'b1 && (! axi_core_cpu_dBus_cmd_m2sPipe_valid)) || axi_core_cpu_dBus_cmd_m2sPipe_ready);
  ...
  assign _zz_96_ = (axi_core_cpu_dBus_cmd_m2sPipe_m2sPipe_s2mPipe_valid && _zz_32_);
  always @ (*) begin
  ...
  assign _zz_95_ = (! (axi_core_dBus_r_payload_resp == (2'b00)));
  ...
  assign _zz_101_ = ((1'b1 && (! axi_core_dBus_decoder_io_input_r_m2sPipe_valid)) || axi_core_dBus_decoder_io_input_r_m2sPipe_ready);
  ...
  assign _zz_105_ = (_zz_57_ && _zz_58_);
  ...
  assign _zz_106_ = axi_core_iBus_decoder_io_outputs_0_ar_payload_addr[11:0];
  assign _zz_59_[2 : 0] = (3'b000);
  assign _zz_107_ = (3'b010);
  assign _zz_108_ = axi_core_dBus_decoder_io_sharedOutputs_1_arw_payload_addr[11:0];
  ...
  assign _zz_111_ = axi_core_iBus_decoder_io_outputs_1_ar_payload_addr[25:0];
  assign _zz_69_[1 : 0] = (2'b00);
  assign _zz_112_ = (3'b010);
  assign _zz_113_ = axi_vgaCtrl_io_axi_decoder_io_outputs_0_ar_payload_addr[25:0];
  assign _zz_70_[1 : 0] = (2'b00);
  assign _zz_114_ = (2'b01);
  assign _zz_115_ = axi_core_dBus_decoder_io_sharedOutputs_2_arw_payload_addr[25:0];
  assign _zz_71_[1 : 0] = (2'b00);
  assign _zz_116_ = (2'b01);
  ...
  assign _zz_118_ = axi_core_dBus_decoder_io_sharedOutputs_0_arw_payload_addr[19:0];
  assign _zz_80_[3 : 0] = (4'b0000);
  assign _zz_119_ = (2'b01);
  ...
  assign _zz_87_ = apb3Router_1__io_outputs_6_PADDR[4:0];
  assign _zz_124_ = 1'b0;
  assign _zz_89_ = apb3Router_1__io_outputs_7_PADDR[3:0];
  assign _zz_125_ = 1'b0;
  assign _zz_88_ = apb3Router_1__io_outputs_8_PADDR[7:0];
  assign _zz_90_ = apb3Router_1__io_outputs_9_PADDR[7:0];
  ...
  always @ (posedge io_axiClk or posedge resetCtrl_axiReset) begin
    if (resetCtrl_axiReset) begin
      ...
      if((streamFork_4__io_outputs_0_valid && _zz_97_))begin
