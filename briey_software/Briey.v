...
`define fsm_enumDefinition_defaultEncoding_fsm_calculate 3'b010
`define fsm_enumDefinition_defaultEncoding_fsm_calcA 3'b011
`define fsm_enumDefinition_defaultEncoding_fsm_calcB 3'b100
`define fsm_enumDefinition_defaultEncoding_fsm_calcDone 3'b101
...
module GCDCtrl (
  ...
  always @(*) begin
    case(fsm_stateReg)
      ...
      `fsm_enumDefinition_defaultEncoding_fsm_calculate : fsm_stateReg_string = "fsm_calculate";
      `fsm_enumDefinition_defaultEncoding_fsm_calcA : fsm_stateReg_string = "fsm_calcA    ";
      `fsm_enumDefinition_defaultEncoding_fsm_calcB : fsm_stateReg_string = "fsm_calcB    ";
      `fsm_enumDefinition_defaultEncoding_fsm_calcDone : fsm_stateReg_string = "fsm_calcDone ";
  ...
  always @(*) begin
    case(fsm_stateNext)
      ...
      `fsm_enumDefinition_defaultEncoding_fsm_calculate : fsm_stateNext_string = "fsm_calculate";
      `fsm_enumDefinition_defaultEncoding_fsm_calcA : fsm_stateNext_string = "fsm_calcA    ";
      `fsm_enumDefinition_defaultEncoding_fsm_calcB : fsm_stateNext_string = "fsm_calcB    ";
      `fsm_enumDefinition_defaultEncoding_fsm_calcDone : fsm_stateNext_string = "fsm_calcDone ";
    ...
    case(fsm_stateReg)
      `fsm_enumDefinition_defaultEncoding_fsm_idle : begin
        if(io_valid)begin
          ...
          fsm_stateNext = `fsm_enumDefinition_defaultEncoding_fsm_calculate;
        end
      end
      `fsm_enumDefinition_defaultEncoding_fsm_calculate : begin
        if(io_dataCtrl_cmpAgtB)begin
          fsm_stateNext = `fsm_enumDefinition_defaultEncoding_fsm_calcA;
        end else begin
          if(io_dataCtrl_cmpAltB)begin
            fsm_stateNext = `fsm_enumDefinition_defaultEncoding_fsm_calcB;
          end else begin
            if(((! io_dataCtrl_cmpAgtB) && (! io_dataCtrl_cmpAgtB)))begin
              fsm_stateNext = `fsm_enumDefinition_defaultEncoding_fsm_calcDone;
            end
          end
        end
      end
      `fsm_enumDefinition_defaultEncoding_fsm_calcA : begin
        io_dataCtrl_selR = 1'b1;
        io_dataCtrl_loadA = 1'b1;
        fsm_stateNext = `fsm_enumDefinition_defaultEncoding_fsm_calculate;
      end
      `fsm_enumDefinition_defaultEncoding_fsm_calcB : begin
        io_dataCtrl_selL = 1'b1;
        io_dataCtrl_loadB = 1'b1;
        fsm_stateNext = `fsm_enumDefinition_defaultEncoding_fsm_calculate;
      end
      `fsm_enumDefinition_defaultEncoding_fsm_calcDone : begin
        io_ready = 1'b1;
...
module GCDTop (
  ...
  GCDCtrl gcdCtr ( 
    .io_valid(io_valid),
    .io_ready(gcdCtr_io_ready),
    .io_dataCtrl_cmpAgtB(gcdDat_io_dataCtrl_cmpAgtB),
    .io_dataCtrl_cmpAltB(gcdDat_io_dataCtrl_cmpAltB),
    .io_dataCtrl_loadA(gcdCtr_io_dataCtrl_loadA),
    .io_dataCtrl_loadB(gcdCtr_io_dataCtrl_loadB),
    .io_dataCtrl_init(gcdCtr_io_dataCtrl_init),
    .io_dataCtrl_selL(gcdCtr_io_dataCtrl_selL),
    .io_dataCtrl_selR(gcdCtr_io_dataCtrl_selR),
    .toplevel_io_axiClk(toplevel_io_axiClk),
    .toplevel_resetCtrl_axiReset(toplevel_resetCtrl_axiReset) 
  );
  GCDData gcdDat ( 
...
module Apb3GCDCtrl (
      ...
      input   toplevel_io_axiClk,
      input   toplevel_resetCtrl_axiReset);
  wire  gcdCtrl_1__io_ready;
  wire [31:0] gcdCtrl_1__io_res;
  wire [0:0] _zz_4_;
  wire  apbCtrl_askWrite;
  wire  apbCtrl_askRead;
  wire  apbCtrl_doWrite;
  wire  apbCtrl_doRead;
  reg [31:0] gcdCtrl_1__io_a_driver;
  reg [31:0] gcdCtrl_1__io_b_driver;
  reg [31:0] resSyncBuf;
  reg  rdySyncBuf;
  reg  _zz_1_;
  reg  _zz_2_;
  ...
  GCDTop gcdCtrl_1_ ( 
    .io_valid(_zz_1_),
    .io_ready(gcdCtrl_1__io_ready),
    .io_a(gcdCtrl_1__io_a_driver),
    .io_b(gcdCtrl_1__io_b_driver),
    .io_res(gcdCtrl_1__io_res),
    .toplevel_io_axiClk(toplevel_io_axiClk),
    .toplevel_resetCtrl_axiReset(toplevel_resetCtrl_axiReset) 
  );
  ...
  always @ (*) begin
    ...
    case(io_apb_PADDR)
      5'b00000 : begin
        io_apb_PRDATA[31 : 0] = gcdCtrl_1__io_a_driver;
      end
      5'b00100 : begin
        io_apb_PRDATA[31 : 0] = gcdCtrl_1__io_b_driver;
      end
      5'b01000 : begin
        io_apb_PRDATA[31 : 0] = resSyncBuf;
      end
      5'b01100 : begin
        io_apb_PRDATA[0 : 0] = rdySyncBuf;
      end
      5'b10000 : begin
  ...
  always @ (posedge toplevel_io_axiClk) begin
    if(gcdCtrl_1__io_ready)begin
      resSyncBuf <= gcdCtrl_1__io_res;
    end
    if(gcdCtrl_1__io_ready)begin
      rdySyncBuf <= gcdCtrl_1__io_ready;
    end
    case(io_apb_PADDR)
      5'b00000 : begin
        if(apbCtrl_doWrite)begin
          gcdCtrl_1__io_a_driver <= io_apb_PWDATA[31 : 0];
        end
      end
      5'b00100 : begin
        if(apbCtrl_doWrite)begin
          gcdCtrl_1__io_b_driver <= io_apb_PWDATA[31 : 0];
        end
      end
      5'b01000 : begin
        if(apbCtrl_doRead)begin
          resSyncBuf <= (32'b00000000000000000000000000000000);
          rdySyncBuf <= 1'b0;
        end
      end
      5'b01100 : begin
...
module VexRiscv (
  ...
  assign _zz_249_ = _zz_137_[1 : 1];
  assign _zz_250_ = _zz_137_[2 : 2];
  assign _zz_251_ = _zz_137_[3 : 3];
  assign _zz_252_ = _zz_137_[8 : 8];
  assign _zz_253_ = _zz_137_[10 : 10];
  assign _zz_254_ = _zz_137_[15 : 15];
  assign _zz_255_ = _zz_137_[16 : 16];
  assign _zz_256_ = _zz_137_[17 : 17];
  assign _zz_257_ = _zz_137_[18 : 18];
  assign _zz_258_ = _zz_137_[19 : 19];
  assign _zz_259_ = _zz_137_[20 : 20];
  assign _zz_260_ = _zz_137_[21 : 21];
  assign _zz_261_ = _zz_137_[22 : 22];
  assign _zz_262_ = _zz_137_[23 : 23];
  assign _zz_263_ = _zz_137_[24 : 24];
  assign _zz_264_ = _zz_137_[27 : 27];
  assign _zz_265_ = _zz_137_[28 : 28];
  ...
  assign _zz_334_ = ((decode_INSTRUCTION & _zz_344_) == (32'b00000000000000000010000000010000));
  assign _zz_335_ = (_zz_345_ == _zz_346_);
  assign _zz_336_ = {_zz_347_,_zz_348_};
  assign _zz_337_ = ((decode_INSTRUCTION & _zz_349_) == (32'b00000000000000000000000000000100));
  assign _zz_338_ = ((decode_INSTRUCTION & _zz_350_) == (32'b00000000000000000000000001000000));
  assign _zz_339_ = {_zz_351_,{_zz_352_,_zz_353_}};
  assign _zz_340_ = (5'b00000);
  assign _zz_341_ = ({_zz_354_,_zz_355_} != (2'b00));
  assign _zz_342_ = (_zz_356_ != _zz_357_);
  assign _zz_343_ = {_zz_358_,{_zz_359_,_zz_360_}};
  assign _zz_344_ = (32'b00000000000000000010000000110000);
  assign _zz_345_ = (decode_INSTRUCTION & (32'b00000000000000000001000000110000));
  assign _zz_346_ = (32'b00000000000000000000000000010000);
  assign _zz_347_ = ((decode_INSTRUCTION & _zz_361_) == (32'b00000000000000000010000000100000));
  assign _zz_348_ = ((decode_INSTRUCTION & _zz_362_) == (32'b00000000000000000000000000100000));
  assign _zz_349_ = (32'b00000000000000000000000000011100);
  assign _zz_350_ = (32'b00000000000000000000000001011000);
  assign _zz_351_ = ((decode_INSTRUCTION & _zz_363_) == (32'b00000000000000000000000001000000));
  assign _zz_352_ = _zz_141_;
  assign _zz_353_ = {_zz_364_,{_zz_365_,_zz_366_}};
  assign _zz_354_ = (_zz_367_ == _zz_368_);
  assign _zz_355_ = (_zz_369_ == _zz_370_);
  assign _zz_356_ = {_zz_141_,_zz_371_};
  assign _zz_357_ = (2'b00);
  assign _zz_358_ = ({_zz_372_,_zz_373_} != (2'b00));
  assign _zz_359_ = (_zz_374_ != _zz_375_);
  assign _zz_360_ = {_zz_376_,{_zz_377_,_zz_378_}};
  assign _zz_361_ = (32'b00000010000000000010000001100000);
  assign _zz_362_ = (32'b00000010000000000011000000100000);
  assign _zz_363_ = (32'b00000000000000000000000001000000);
  assign _zz_364_ = ((decode_INSTRUCTION & (32'b00000000000000000100000000100000)) == (32'b00000000000000000100000000100000));
  assign _zz_365_ = ((decode_INSTRUCTION & _zz_379_) == (32'b00000000000000000000000000010000));
  assign _zz_366_ = ((decode_INSTRUCTION & _zz_380_) == (32'b00000000000000000000000000100000));
  assign _zz_367_ = (decode_INSTRUCTION & (32'b00000000000000000001000001010000));
  assign _zz_368_ = (32'b00000000000000000001000001010000);
  assign _zz_369_ = (decode_INSTRUCTION & (32'b00000000000000000010000001010000));
  assign _zz_370_ = (32'b00000000000000000010000001010000);
  ...
  assign _zz_373_ = ((decode_INSTRUCTION & _zz_381_) == (32'b00000000000000000000000000000000));
  assign _zz_374_ = _zz_140_;
  assign _zz_375_ = (1'b0);
  assign _zz_376_ = (_zz_140_ != (1'b0));
  assign _zz_377_ = (_zz_382_ != (1'b0));
  assign _zz_378_ = {(_zz_383_ != _zz_384_),{_zz_385_,{_zz_386_,_zz_387_}}};
  assign _zz_379_ = (32'b00000000000000000000000000110000);
  assign _zz_380_ = (32'b00000010000000000000000000100000);
  assign _zz_381_ = (32'b00000000000000000000000000100000);
  assign _zz_382_ = ((decode_INSTRUCTION & (32'b00000010000000000100000001100100)) == (32'b00000010000000000100000000100000));
  ...
  assign _zz_385_ = (((decode_INSTRUCTION & _zz_388_) == (32'b00000000000000000000000000100000)) != (1'b0));
  assign _zz_386_ = ({_zz_389_,_zz_390_} != (2'b00));
  assign _zz_387_ = {(_zz_391_ != (1'b0)),{(_zz_392_ != _zz_393_),{_zz_394_,{_zz_395_,_zz_396_}}}};
  assign _zz_388_ = (32'b00000000000000000000000000100000);
  assign _zz_389_ = ((decode_INSTRUCTION & (32'b00000000000000000010000000010000)) == (32'b00000000000000000010000000000000));
  assign _zz_390_ = ((decode_INSTRUCTION & (32'b00000000000000000101000000000000)) == (32'b00000000000000000001000000000000));
  assign _zz_391_ = ((decode_INSTRUCTION & (32'b00000000000000000101000001001000)) == (32'b00000000000000000001000000001000));
  assign _zz_392_ = ((decode_INSTRUCTION & _zz_397_) == (32'b00000000000000000000000001010000));
  assign _zz_393_ = (1'b0);
  assign _zz_394_ = ({_zz_139_,{_zz_398_,_zz_399_}} != (6'b000000));
  assign _zz_395_ = (_zz_400_ != (1'b0));
  assign _zz_396_ = {(_zz_401_ != _zz_402_),{_zz_403_,{_zz_404_,_zz_405_}}};
  assign _zz_397_ = (32'b00010000000000000011000001010000);
  ...
  assign _zz_401_ = {(_zz_412_ == _zz_413_),_zz_138_};
  assign _zz_402_ = (2'b00);
  assign _zz_403_ = ({_zz_414_,_zz_138_} != (2'b00));
  assign _zz_404_ = (_zz_415_ != (1'b0));
  assign _zz_405_ = {(_zz_416_ != _zz_417_),{_zz_418_,{_zz_419_,_zz_420_}}};
  ...
  assign _zz_409_ = ((decode_INSTRUCTION & (32'b00000000000000000000000001010000)) == (32'b00000000000000000000000000010000));
  assign _zz_410_ = ((decode_INSTRUCTION & _zz_421_) == (32'b00000000000000000000000000000100));
  assign _zz_411_ = ((decode_INSTRUCTION & _zz_422_) == (32'b00000000000000000000000000000000));
  ...
  assign _zz_415_ = ((decode_INSTRUCTION & (32'b00000000000000000001000000000000)) == (32'b00000000000000000001000000000000));
  assign _zz_416_ = ((decode_INSTRUCTION & _zz_423_) == (32'b00000000000000000010000000000000));
  assign _zz_417_ = (1'b0);
  assign _zz_418_ = ((_zz_424_ == _zz_425_) != (1'b0));
  assign _zz_419_ = ({_zz_426_,_zz_427_} != (3'b000));
  assign _zz_420_ = {(_zz_428_ != _zz_429_),{_zz_430_,{_zz_431_,_zz_432_}}};
  assign _zz_421_ = (32'b00000000000000000000000000001100);
  assign _zz_422_ = (32'b00000000000000000000000000101000);
  assign _zz_423_ = (32'b00000000000000000011000000000000);
  assign _zz_424_ = (decode_INSTRUCTION & (32'b00000000000000000000000001100100));
  assign _zz_425_ = (32'b00000000000000000000000000100100);
  assign _zz_426_ = ((decode_INSTRUCTION & _zz_433_) == (32'b00000000000000000000000001000000));
  assign _zz_427_ = {(_zz_434_ == _zz_435_),(_zz_436_ == _zz_437_)};
  assign _zz_428_ = {(_zz_438_ == _zz_439_),(_zz_440_ == _zz_441_)};
  assign _zz_429_ = (2'b00);
  assign _zz_430_ = ((_zz_442_ == _zz_443_) != (1'b0));
  assign _zz_431_ = (_zz_444_ != (1'b0));
  assign _zz_432_ = {(_zz_445_ != _zz_446_),{_zz_447_,{_zz_448_,_zz_449_}}};
  assign _zz_433_ = (32'b00000000000000000000000001010000);
  assign _zz_434_ = (decode_INSTRUCTION & (32'b00000000000000000000000000111000));
  assign _zz_435_ = (32'b00000000000000000000000000000000);
  assign _zz_436_ = (decode_INSTRUCTION & (32'b00000000000100000011000001000000));
  assign _zz_437_ = (32'b00000000000000000000000001000000);
  assign _zz_438_ = (decode_INSTRUCTION & (32'b00000000000000000000000000110100));
  assign _zz_439_ = (32'b00000000000000000000000000100000);
  assign _zz_440_ = (decode_INSTRUCTION & (32'b00000000000000000000000001100100));
  assign _zz_441_ = (32'b00000000000000000000000000100000);
  assign _zz_442_ = (decode_INSTRUCTION & (32'b00000000000000000100000000010100));
  assign _zz_443_ = (32'b00000000000000000100000000010000);
  assign _zz_444_ = ((decode_INSTRUCTION & (32'b00000000000000000110000000010100)) == (32'b00000000000000000010000000010000));
  assign _zz_445_ = {(_zz_450_ == _zz_451_),(_zz_452_ == _zz_453_)};
  assign _zz_446_ = (2'b00);
  assign _zz_447_ = ({_zz_454_,{_zz_455_,_zz_456_}} != (3'b000));
  assign _zz_448_ = (_zz_457_ != (1'b0));
  assign _zz_449_ = {(_zz_458_ != _zz_459_),{_zz_460_,_zz_461_}};
  assign _zz_450_ = (decode_INSTRUCTION & (32'b00000000000000000111000000110100));
  assign _zz_451_ = (32'b00000000000000000101000000010000);
  assign _zz_452_ = (decode_INSTRUCTION & (32'b00000010000000000111000001100100));
  assign _zz_453_ = (32'b00000000000000000101000000100000);
  assign _zz_454_ = ((decode_INSTRUCTION & (32'b01000000000000000011000001010100)) == (32'b01000000000000000001000000010000));
  assign _zz_455_ = ((decode_INSTRUCTION & _zz_462_) == (32'b00000000000000000001000000010000));
  assign _zz_456_ = ((decode_INSTRUCTION & _zz_463_) == (32'b00000000000000000001000000010000));
  assign _zz_457_ = ((decode_INSTRUCTION & (32'b00000000000000000100000001001000)) == (32'b00000000000000000100000000001000));
  assign _zz_458_ = {(_zz_464_ == _zz_465_),{_zz_466_,{_zz_467_,_zz_468_}}};
  assign _zz_459_ = (4'b0000);
  assign _zz_460_ = ({_zz_469_,{_zz_470_,_zz_471_}} != (3'b000));
  assign _zz_461_ = ((_zz_472_ == _zz_473_) != (1'b0));
  assign _zz_462_ = (32'b00000000000000000111000000110100);
  assign _zz_463_ = (32'b00000010000000000111000001010100);
  ...
  assign _zz_466_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000011000)) == (32'b00000000000000000000000000000000));
  assign _zz_467_ = ((decode_INSTRUCTION & (32'b00000000000000000110000000000100)) == (32'b00000000000000000010000000000000));
  assign _zz_468_ = ((decode_INSTRUCTION & (32'b00000000000000000101000000000100)) == (32'b00000000000000000001000000000000));
  assign _zz_469_ = ((decode_INSTRUCTION & (32'b00000000000000000000000001000100)) == (32'b00000000000000000000000001000000));
  assign _zz_470_ = ((decode_INSTRUCTION & (32'b00000000000000000010000000010100)) == (32'b00000000000000000010000000010000));
  assign _zz_471_ = ((decode_INSTRUCTION & (32'b01000000000000000000000000110100)) == (32'b01000000000000000000000000110000));
  ...
  assign _zz_474_ = (32'b00000000000000000001000001111111);
  assign _zz_475_ = (decode_INSTRUCTION & (32'b00000000000000000010000001111111));
  assign _zz_476_ = (32'b00000000000000000010000001110011);
  assign _zz_477_ = ((decode_INSTRUCTION & (32'b00000000000000000100000001111111)) == (32'b00000000000000000100000001100011));
  assign _zz_478_ = ((decode_INSTRUCTION & (32'b00000000000000000010000001111111)) == (32'b00000000000000000010000000010011));
  assign _zz_479_ = {((decode_INSTRUCTION & (32'b00000000000000000110000000111111)) == (32'b00000000000000000000000000100011)),{((decode_INSTRUCTION & (32'b00000000000000000010000001111111)) == (32'b00000000000000000000000000000011)),{((decode_INSTRUCTION & _zz_480_) == (32'b00000000000000000000000000000011)),{(_zz_481_ == _zz_482_),{_zz_483_,{_zz_484_,_zz_485_}}}}}};
  assign _zz_480_ = (32'b00000000000000000101000001011111);
  assign _zz_481_ = (decode_INSTRUCTION & (32'b00000000000000000111000001111011));
  assign _zz_482_ = (32'b00000000000000000000000001100011);
  assign _zz_483_ = ((decode_INSTRUCTION & (32'b00000000000000000110000001111111)) == (32'b00000000000000000000000000001111));
  assign _zz_484_ = ((decode_INSTRUCTION & (32'b11111100000000000000000001111111)) == (32'b00000000000000000000000000110011));
  assign _zz_485_ = {((decode_INSTRUCTION & (32'b00000001111100000111000001111111)) == (32'b00000000000000000101000000001111)),{((decode_INSTRUCTION & (32'b10111100000000000111000001111111)) == (32'b00000000000000000101000000010011)),{((decode_INSTRUCTION & _zz_486_) == (32'b00000000000000000001000000010011)),{(_zz_487_ == _zz_488_),{_zz_489_,{_zz_490_,_zz_491_}}}}}};
  assign _zz_486_ = (32'b11111100000000000011000001111111);
  assign _zz_487_ = (decode_INSTRUCTION & (32'b10111110000000000111000001111111));
  assign _zz_488_ = (32'b00000000000000000101000000110011);
  assign _zz_489_ = ((decode_INSTRUCTION & (32'b10111110000000000111000001111111)) == (32'b00000000000000000000000000110011));
  assign _zz_490_ = ((decode_INSTRUCTION & (32'b11011111111111111111111111111111)) == (32'b00010000001000000000000001110011));
  assign _zz_491_ = ((decode_INSTRUCTION & (32'b11111111111111111111111111111111)) == (32'b00000000000100000000000001110011));
  assign _zz_492_ = execute_INSTRUCTION[31];
  assign _zz_493_ = execute_INSTRUCTION[31];
  assign _zz_494_ = execute_INSTRUCTION[7];
  always @ (posedge toplevel_io_axiClk) begin
    if(_zz_62_) begin
  ...
  assign decode_ALU_BITWISE_CTRL = _zz_3_;
  ...
  assign _zz_137_ = {({_zz_141_,{_zz_334_,{_zz_335_,_zz_336_}}} != (5'b00000)),{({_zz_139_,_zz_337_} != (2'b00)),{(_zz_338_ != (1'b0)),{(_zz_339_ != _zz_340_),{_zz_341_,{_zz_342_,_zz_343_}}}}}};
  assign _zz_90_ = ({((decode_INSTRUCTION & (32'b00000000000000000000000001011111)) == (32'b00000000000000000000000000010111)),{((decode_INSTRUCTION & (32'b00000000000000000000000001111111)) == (32'b00000000000000000000000001101111)),{((decode_INSTRUCTION & (32'b00000000000000000001000001101111)) == (32'b00000000000000000000000000000011)),{((decode_INSTRUCTION & _zz_474_) == (32'b00000000000000000001000001110011)),{(_zz_475_ == _zz_476_),{_zz_477_,{_zz_478_,_zz_479_}}}}}}} != (20'b00000000000000000000));
  assign _zz_142_ = _zz_137_[0 : 0];
  ...
  assign _zz_85_ = _zz_143_;
  assign _zz_144_ = _zz_137_[7 : 6];
  assign _zz_84_ = _zz_144_;
  assign _zz_83_ = _zz_252_[0];
  assign _zz_82_ = _zz_253_[0];
  assign _zz_145_ = _zz_137_[12 : 11];
  assign _zz_81_ = _zz_145_;
  assign _zz_146_ = _zz_137_[14 : 13];
  assign _zz_80_ = _zz_146_;
  assign _zz_79_ = _zz_254_[0];
  assign _zz_78_ = _zz_255_[0];
  assign _zz_77_ = _zz_256_[0];
  assign _zz_76_ = _zz_257_[0];
  assign _zz_75_ = _zz_258_[0];
  assign _zz_74_ = _zz_259_[0];
  assign _zz_73_ = _zz_260_[0];
  assign _zz_72_ = _zz_261_[0];
  assign _zz_71_ = _zz_262_[0];
  ...
  always @ (*) begin
    case(execute_BRANCH_CTRL)
      ...
      default : begin
        ...
        execute_BranchPlugin_branch_src2 = ((execute_BRANCH_CTRL == `BranchCtrlEnum_defaultEncoding_JAL) ? {{_zz_191_,{{{_zz_492_,execute_INSTRUCTION[19 : 12]},execute_INSTRUCTION[20]},execute_INSTRUCTION[30 : 21]}},1'b0} : {{_zz_193_,{{{_zz_493_,_zz_494_},execute_INSTRUCTION[30 : 25]},execute_INSTRUCTION[11 : 8]}},1'b0});
  ...
  always @ (posedge toplevel_io_axiClk) begin
    ...
    if((! execute_arbitration_isStuck))begin
      decode_to_execute_ALU_BITWISE_CTRL <= _zz_4_;
    end
    if((! execute_arbitration_isStuck))begin
...
module Apb3Decoder (
  ...
  always @ (*) begin
    ...
    io_output_PSEL[3] = (((io_input_PADDR & _zz_4_) == (20'b00010000000000000000)) && io_input_PSEL[0]);
...
module Briey (
  ...
  wire  axi_gcd_io_apb_PREADY;
  wire [31:0] axi_gcd_io_apb_PRDATA;
  ...
  assign _zz_119_ = (resetCtrl_systemResetCounter != _zz_1_);
  assign _zz_120_ = (axi_core_cpu_dBus_cmd_m2sPipe_m2sPipe_ready && (! axi_core_cpu_dBus_cmd_m2sPipe_m2sPipe_s2mPipe_ready));
  assign _zz_121_ = (! axi_vgaCtrl_io_axi_ar_halfPipe_regs_valid);
  assign _zz_122_ = (! axi_ram_io_axi_arbiter_io_output_arw_halfPipe_regs_valid);
  assign _zz_123_ = (_zz_106_ && (! axi_ram_io_axi_arbiter_io_output_w_s2mPipe_ready));
  assign _zz_124_ = (! axi_sdramCtrl_io_axi_arbiter_io_output_arw_halfPipe_regs_valid);
  assign _zz_125_ = (_zz_113_ && (! axi_sdramCtrl_io_axi_arbiter_io_output_w_s2mPipe_ready));
  assign _zz_126_ = (! axi_apbBridge_io_axi_arbiter_io_output_arw_halfPipe_regs_valid);
  assign _zz_127_ = (! axi_apbBridge_io_axi_arbiter_io_output_w_halfPipe_regs_valid);
  ...
  VexRiscv axi_core_cpu ( 
    ...
    .debug_bus_cmd_payload_address(_zz_88_),
    ...
    .iBus_rsp_payload_error(_zz_89_),
    .dBus_cmd_valid(axi_core_cpu_dBus_cmd_valid),
    .dBus_cmd_ready(_zz_90_),
  ...
  Axi4SharedDecoder axi_core_dBus_decoder ( 
    ...
    .io_sharedOutputs_0_arw_ready(_zz_98_),
    ...
    .io_sharedOutputs_1_arw_ready(_zz_99_),
    ...
    .io_sharedOutputs_2_arw_ready(_zz_100_),
  ...
  Axi4ReadOnlyDecoder_1_ axi_vgaCtrl_io_axi_decoder ( 
    ...
    .io_outputs_0_ar_ready(_zz_101_),
  ...
  Axi4SharedArbiter_1_ axi_sdramCtrl_io_axi_arbiter ( 
    ...
    .io_readInputs_1_ar_payload_addr(_zz_109_),
    ...
    .io_readInputs_1_ar_payload_burst(_zz_110_),
  ...
  Apb3Router apb3Router_1_ ( 
    ...
    .io_outputs_2_PREADY(axi_gcd_io_apb_PREADY),
    .io_outputs_2_PWRITE(apb3Router_1__io_outputs_2_PWRITE),
    .io_outputs_2_PWDATA(apb3Router_1__io_outputs_2_PWDATA),
    .io_outputs_2_PRDATA(axi_gcd_io_apb_PRDATA),
    .io_outputs_2_PSLVERROR(_zz_116_),
    ...
    .io_outputs_3_PREADY(axi_uartCtrl_io_apb_PREADY),
    .io_outputs_3_PWRITE(apb3Router_1__io_outputs_3_PWRITE),
    .io_outputs_3_PWDATA(apb3Router_1__io_outputs_3_PWDATA),
    .io_outputs_3_PRDATA(axi_uartCtrl_io_apb_PRDATA),
    .io_outputs_3_PSLVERROR(_zz_117_),
    ...
    .io_outputs_4_PREADY(axi_timerCtrl_io_apb_PREADY),
    .io_outputs_4_PWRITE(apb3Router_1__io_outputs_4_PWRITE),
    .io_outputs_4_PWDATA(apb3Router_1__io_outputs_4_PWDATA),
    .io_outputs_4_PRDATA(axi_timerCtrl_io_apb_PRDATA),
    .io_outputs_4_PSLVERROR(axi_timerCtrl_io_apb_PSLVERROR),
    ...
    .io_outputs_5_PREADY(axi_vgaCtrl_io_apb_PREADY),
    .io_outputs_5_PWRITE(apb3Router_1__io_outputs_5_PWRITE),
    .io_outputs_5_PWDATA(apb3Router_1__io_outputs_5_PWDATA),
    .io_outputs_5_PRDATA(axi_vgaCtrl_io_apb_PRDATA),
    .io_outputs_5_PSLVERROR(_zz_118_),
    .toplevel_io_axiClk(io_axiClk),
    .toplevel_resetCtrl_axiReset(resetCtrl_axiReset) 
  );
  always @ (*) begin
  ...
  assign _zz_89_ = (! (axi_core_iBus_r_payload_resp == (2'b00)));
  ...
  assign _zz_90_ = ((1'b1 && (! axi_core_cpu_dBus_cmd_m2sPipe_valid)) || axi_core_cpu_dBus_cmd_m2sPipe_ready);
  ...
  assign _zz_92_ = (axi_core_cpu_dBus_cmd_m2sPipe_m2sPipe_s2mPipe_valid && _zz_32_);
  always @ (*) begin
  ...
  assign _zz_91_ = (! (axi_core_dBus_r_payload_resp == (2'b00)));
  ...
  assign _zz_97_ = ((1'b1 && (! axi_core_dBus_decoder_io_input_r_m2sPipe_valid)) || axi_core_dBus_decoder_io_input_r_m2sPipe_ready);
  ...
  assign _zz_101_ = (_zz_57_ && _zz_58_);
  ...
  assign _zz_102_ = axi_core_iBus_decoder_io_outputs_0_ar_payload_addr[11:0];
  assign _zz_59_[2 : 0] = (3'b000);
  assign _zz_103_ = (3'b010);
  assign _zz_104_ = axi_core_dBus_decoder_io_sharedOutputs_1_arw_payload_addr[11:0];
  ...
  assign _zz_107_ = axi_core_iBus_decoder_io_outputs_1_ar_payload_addr[25:0];
  assign _zz_69_[1 : 0] = (2'b00);
  assign _zz_108_ = (3'b010);
  assign _zz_109_ = axi_vgaCtrl_io_axi_decoder_io_outputs_0_ar_payload_addr[25:0];
  assign _zz_70_[1 : 0] = (2'b00);
  assign _zz_110_ = (2'b01);
  assign _zz_111_ = axi_core_dBus_decoder_io_sharedOutputs_2_arw_payload_addr[25:0];
  ...
  assign _zz_114_ = axi_core_dBus_decoder_io_sharedOutputs_0_arw_payload_addr[19:0];
  ...
  assign _zz_82_ = apb3Router_1__io_outputs_0_PADDR[3:0];
  assign _zz_83_ = apb3Router_1__io_outputs_1_PADDR[3:0];
  assign _zz_81_ = apb3Router_1__io_outputs_2_PADDR[4:0];
  assign _zz_116_ = 1'b0;
  assign _zz_85_ = apb3Router_1__io_outputs_3_PADDR[3:0];
  assign _zz_117_ = 1'b0;
  assign _zz_84_ = apb3Router_1__io_outputs_4_PADDR[7:0];
  assign _zz_86_ = apb3Router_1__io_outputs_5_PADDR[7:0];
  ...
  always @ (posedge io_axiClk or posedge resetCtrl_axiReset) begin
    if (resetCtrl_axiReset) begin
      ...
      if((streamFork_4__io_outputs_0_valid && _zz_93_))begin
