...
// Date      : 18/07/2022, 14:40:38
// Component : Briey

`include "/home/linh/KLTN/Library/Verilog_code/Avalon_test_module.v"
...
module Apb3AVLCtrl (
  ...
  wire  apbCtrl_doWrite;
  wire  apbCtrl_doRead;
  reg  AVL_module_iChipselect_driver;
  reg  AVL_module_iWrite_n_driver;
  reg  AVL_module_iRead_n_driver;
  reg [1:0] AVL_module_iAddress_driver;
  reg [31:0] AVL_module_iData_driver;
  assign _zz_1_ = io_apb_PWDATA[0 : 0];
  assign _zz_2_ = io_apb_PWDATA[0 : 0];
  assign _zz_3_ = io_apb_PWDATA[0 : 0];
  Avalon_test_module AVL_module ( 
    .iClk(toplevel_io_axiClk),
    .iReset(toplevel_resetCtrl_axiReset),
    .iChipselect(AVL_module_iChipselect_driver),
    .iWrite_n(AVL_module_iWrite_n_driver),
    .iRead_n(AVL_module_iRead_n_driver),
    .iAddress(AVL_module_iAddress_driver),
    .iData(AVL_module_iData_driver),
    .oData(AVL_module_oData) 
  );
  assign io_apb_PREADY = 1'b1;
  always @ (*) begin
    io_apb_PRDATA = (32'b00000000000000000000000000000000);
    case(io_apb_PADDR)
      5'b00000 : begin
        io_apb_PRDATA[0 : 0] = AVL_module_iChipselect_driver;
      end
      5'b00100 : begin
        io_apb_PRDATA[0 : 0] = AVL_module_iWrite_n_driver;
      end
      5'b01000 : begin
        io_apb_PRDATA[0 : 0] = AVL_module_iRead_n_driver;
      end
      5'b01100 : begin
        io_apb_PRDATA[1 : 0] = AVL_module_iAddress_driver;
      end
      5'b10000 : begin
        io_apb_PRDATA[31 : 0] = AVL_module_iData_driver;
      end
      5'b10100 : begin
        io_apb_PRDATA[31 : 0] = AVL_module_oData;
      end
      default : begin
      end
    endcase
  ...
  always @ (posedge toplevel_io_axiClk) begin
    case(io_apb_PADDR)
      5'b00000 : begin
        if(apbCtrl_doWrite)begin
          AVL_module_iChipselect_driver <= _zz_1_[0];
        end
      end
      5'b00100 : begin
        if(apbCtrl_doWrite)begin
          AVL_module_iWrite_n_driver <= _zz_2_[0];
        end
      end
      5'b01000 : begin
        if(apbCtrl_doWrite)begin
          AVL_module_iRead_n_driver <= _zz_3_[0];
        end
      end
      5'b01100 : begin
        if(apbCtrl_doWrite)begin
          AVL_module_iAddress_driver <= io_apb_PWDATA[1 : 0];
        end
      end
      5'b10000 : begin
        if(apbCtrl_doWrite)begin
          AVL_module_iData_driver <= io_apb_PWDATA[31 : 0];
        end
      end
      5'b10100 : begin
      end
...
module VexRiscv (
  ...
  assign _zz_251_ = _zz_137_[6 : 6];
  assign _zz_252_ = _zz_137_[7 : 7];
  assign _zz_253_ = _zz_137_[8 : 8];
  assign _zz_254_ = _zz_137_[9 : 9];
  assign _zz_255_ = _zz_137_[11 : 11];
  assign _zz_256_ = _zz_137_[15 : 15];
  assign _zz_257_ = _zz_137_[16 : 16];
  ...
  assign _zz_338_ = (decode_INSTRUCTION & (32'b00000000000000000100000001001000));
  assign _zz_339_ = (32'b00000000000000000100000000001000);
  ...
  assign _zz_343_ = ({_zz_139_,(_zz_346_ == _zz_347_)} != (2'b00));
  assign _zz_344_ = ((_zz_348_ == _zz_349_) != (1'b0));
  assign _zz_345_ = {({_zz_350_,_zz_351_} != (5'b00000)),{(_zz_352_ != _zz_353_),{_zz_354_,{_zz_355_,_zz_356_}}}};
  assign _zz_346_ = (decode_INSTRUCTION & (32'b00000000000000000000000000011100));
  assign _zz_347_ = (32'b00000000000000000000000000000100);
  assign _zz_348_ = (decode_INSTRUCTION & (32'b00000000000000000000000001011000));
  assign _zz_349_ = (32'b00000000000000000000000001000000);
  assign _zz_350_ = ((decode_INSTRUCTION & _zz_357_) == (32'b00000000000000000000000001000000));
  assign _zz_351_ = {_zz_138_,{_zz_358_,{_zz_359_,_zz_360_}}};
  assign _zz_352_ = {(_zz_361_ == _zz_362_),(_zz_363_ == _zz_364_)};
  assign _zz_353_ = (2'b00);
  assign _zz_354_ = ({_zz_365_,{_zz_366_,_zz_367_}} != (3'b000));
  assign _zz_355_ = (_zz_141_ != (1'b0));
  assign _zz_356_ = {(_zz_368_ != _zz_369_),{_zz_370_,{_zz_371_,_zz_372_}}};
  assign _zz_357_ = (32'b00000000000000000000000001000000);
  assign _zz_358_ = ((decode_INSTRUCTION & _zz_373_) == (32'b00000000000000000100000000100000));
  assign _zz_359_ = (_zz_374_ == _zz_375_);
  assign _zz_360_ = (_zz_376_ == _zz_377_);
  assign _zz_361_ = (decode_INSTRUCTION & (32'b00000000000000000111000000110100));
  assign _zz_362_ = (32'b00000000000000000101000000010000);
  assign _zz_363_ = (decode_INSTRUCTION & (32'b00000010000000000111000001100100));
  assign _zz_364_ = (32'b00000000000000000101000000100000);
  assign _zz_365_ = ((decode_INSTRUCTION & _zz_378_) == (32'b01000000000000000001000000010000));
  assign _zz_366_ = (_zz_379_ == _zz_380_);
  assign _zz_367_ = (_zz_381_ == _zz_382_);
  assign _zz_368_ = (_zz_383_ == _zz_384_);
  assign _zz_369_ = (1'b0);
  assign _zz_370_ = (_zz_141_ != (1'b0));
  assign _zz_371_ = (_zz_385_ != _zz_386_);
  assign _zz_372_ = {_zz_387_,{_zz_388_,_zz_389_}};
  assign _zz_373_ = (32'b00000000000000000100000000100000);
  assign _zz_374_ = (decode_INSTRUCTION & (32'b00000000000000000000000000110000));
  assign _zz_375_ = (32'b00000000000000000000000000010000);
  assign _zz_376_ = (decode_INSTRUCTION & (32'b00000010000000000000000000100000));
  assign _zz_377_ = (32'b00000000000000000000000000100000);
  assign _zz_378_ = (32'b01000000000000000011000001010100);
  assign _zz_379_ = (decode_INSTRUCTION & (32'b00000000000000000111000000110100));
  assign _zz_380_ = (32'b00000000000000000001000000010000);
  assign _zz_381_ = (decode_INSTRUCTION & (32'b00000010000000000111000001010100));
  assign _zz_382_ = (32'b00000000000000000001000000010000);
  assign _zz_383_ = (decode_INSTRUCTION & (32'b00000000000000000000000000100000));
  assign _zz_384_ = (32'b00000000000000000000000000100000);
  assign _zz_385_ = {(_zz_390_ == _zz_391_),{_zz_392_,{_zz_393_,_zz_394_}}};
  assign _zz_386_ = (4'b0000);
  assign _zz_387_ = ((_zz_395_ == _zz_396_) != (1'b0));
  assign _zz_388_ = ({_zz_397_,_zz_398_} != (3'b000));
  assign _zz_389_ = {(_zz_399_ != _zz_400_),{_zz_401_,{_zz_402_,_zz_403_}}};
  assign _zz_390_ = (decode_INSTRUCTION & (32'b00000000000000000000000001000100));
  assign _zz_391_ = (32'b00000000000000000000000000000000);
  assign _zz_392_ = ((decode_INSTRUCTION & _zz_404_) == (32'b00000000000000000000000000000000));
  assign _zz_393_ = (_zz_405_ == _zz_406_);
  assign _zz_394_ = (_zz_407_ == _zz_408_);
  assign _zz_395_ = (decode_INSTRUCTION & (32'b00000010000000000100000001100100));
  assign _zz_396_ = (32'b00000010000000000100000000100000);
  assign _zz_397_ = (_zz_409_ == _zz_410_);
  assign _zz_398_ = {_zz_411_,_zz_412_};
  assign _zz_399_ = (_zz_413_ == _zz_414_);
  assign _zz_400_ = (1'b0);
  assign _zz_401_ = ({_zz_415_,_zz_416_} != (2'b00));
  assign _zz_402_ = (_zz_417_ != _zz_418_);
  assign _zz_403_ = {_zz_419_,{_zz_420_,_zz_421_}};
  assign _zz_404_ = (32'b00000000000000000000000000011000);
  assign _zz_405_ = (decode_INSTRUCTION & (32'b00000000000000000110000000000100));
  assign _zz_406_ = (32'b00000000000000000010000000000000);
  assign _zz_407_ = (decode_INSTRUCTION & (32'b00000000000000000101000000000100));
  assign _zz_408_ = (32'b00000000000000000001000000000000);
  ...
  assign _zz_411_ = ((decode_INSTRUCTION & _zz_422_) == (32'b00000000000000000010000000010000));
  assign _zz_412_ = ((decode_INSTRUCTION & _zz_423_) == (32'b01000000000000000000000000110000));
  assign _zz_413_ = (decode_INSTRUCTION & (32'b00000000000000000000000001100100));
  assign _zz_414_ = (32'b00000000000000000000000000100100);
  assign _zz_415_ = (_zz_424_ == _zz_425_);
  assign _zz_416_ = (_zz_426_ == _zz_427_);
  assign _zz_417_ = {_zz_428_,_zz_140_};
  assign _zz_418_ = (2'b00);
  assign _zz_419_ = ({_zz_429_,_zz_430_} != (2'b00));
  assign _zz_420_ = (_zz_431_ != _zz_432_);
  assign _zz_421_ = {_zz_433_,{_zz_434_,_zz_435_}};
  assign _zz_422_ = (32'b00000000000000000010000000010100);
  assign _zz_423_ = (32'b01000000000000000000000000110100);
  assign _zz_424_ = (decode_INSTRUCTION & (32'b00000000000000000000000000110100));
  assign _zz_425_ = (32'b00000000000000000000000000100000);
  assign _zz_426_ = (decode_INSTRUCTION & (32'b00000000000000000000000001100100));
  assign _zz_427_ = (32'b00000000000000000000000000100000);
  assign _zz_428_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000010100)) == (32'b00000000000000000000000000000100));
  assign _zz_429_ = ((decode_INSTRUCTION & _zz_436_) == (32'b00000000000000000000000000000100));
  assign _zz_430_ = _zz_140_;
  assign _zz_431_ = ((decode_INSTRUCTION & _zz_437_) == (32'b00000000000000000000000001010000));
  assign _zz_432_ = (1'b0);
  assign _zz_433_ = ((_zz_438_ == _zz_439_) != (1'b0));
  assign _zz_434_ = ({_zz_440_,_zz_441_} != (3'b000));
  assign _zz_435_ = {(_zz_442_ != _zz_443_),{_zz_444_,{_zz_445_,_zz_446_}}};
  assign _zz_436_ = (32'b00000000000000000000000001000100);
  assign _zz_437_ = (32'b00000000000100000011000001010000);
  assign _zz_438_ = (decode_INSTRUCTION & (32'b00000010000000000100000001110100));
  assign _zz_439_ = (32'b00000010000000000000000000110000);
  assign _zz_440_ = ((decode_INSTRUCTION & _zz_447_) == (32'b00000000000000000000000001000000));
  assign _zz_441_ = {(_zz_448_ == _zz_449_),(_zz_450_ == _zz_451_)};
  assign _zz_442_ = ((decode_INSTRUCTION & _zz_452_) == (32'b00000000000000000000000001010000));
  assign _zz_443_ = (1'b0);
  assign _zz_444_ = ((_zz_453_ == _zz_454_) != (1'b0));
  assign _zz_445_ = ({_zz_455_,_zz_456_} != (6'b000000));
  assign _zz_446_ = {(_zz_457_ != _zz_458_),{_zz_459_,{_zz_460_,_zz_461_}}};
  assign _zz_447_ = (32'b00000000000000000000000001010000);
  assign _zz_448_ = (decode_INSTRUCTION & (32'b00000000000000000000000000111000));
  assign _zz_449_ = (32'b00000000000000000000000000000000);
  assign _zz_450_ = (decode_INSTRUCTION & (32'b00000000000100000011000001000000));
  assign _zz_451_ = (32'b00000000000000000000000001000000);
  assign _zz_452_ = (32'b00010000000000000011000001010000);
  assign _zz_453_ = (decode_INSTRUCTION & (32'b00000000000000000000000001011000));
  assign _zz_454_ = (32'b00000000000000000000000000000000);
  assign _zz_455_ = _zz_139_;
  assign _zz_456_ = {(_zz_462_ == _zz_463_),{_zz_464_,{_zz_465_,_zz_466_}}};
  assign _zz_457_ = {_zz_138_,{_zz_467_,{_zz_468_,_zz_469_}}};
  assign _zz_458_ = (5'b00000);
  assign _zz_459_ = ({_zz_138_,_zz_470_} != (2'b00));
  assign _zz_460_ = ({_zz_471_,_zz_472_} != (2'b00));
  assign _zz_461_ = {(_zz_473_ != _zz_474_),{_zz_475_,{_zz_476_,_zz_477_}}};
  assign _zz_462_ = (decode_INSTRUCTION & (32'b00000000000000000001000000010000));
  assign _zz_463_ = (32'b00000000000000000001000000010000);
  assign _zz_464_ = ((decode_INSTRUCTION & _zz_478_) == (32'b00000000000000000010000000010000));
  assign _zz_465_ = (_zz_479_ == _zz_480_);
  assign _zz_466_ = {_zz_481_,_zz_482_};
  assign _zz_467_ = ((decode_INSTRUCTION & _zz_483_) == (32'b00000000000000000010000000010000));
  assign _zz_468_ = (_zz_484_ == _zz_485_);
  assign _zz_469_ = {_zz_486_,_zz_487_};
  assign _zz_470_ = ((decode_INSTRUCTION & _zz_488_) == (32'b00000000000000000000000000100000));
  assign _zz_471_ = _zz_138_;
  assign _zz_472_ = (_zz_489_ == _zz_490_);
  assign _zz_473_ = (_zz_491_ == _zz_492_);
  assign _zz_474_ = (1'b0);
  assign _zz_475_ = (_zz_493_ != (1'b0));
  assign _zz_476_ = (_zz_494_ != _zz_495_);
  assign _zz_477_ = (_zz_496_ != _zz_497_);
  assign _zz_478_ = (32'b00000000000000000010000000010000);
  assign _zz_479_ = (decode_INSTRUCTION & (32'b00000000000000000000000001010000));
  assign _zz_480_ = (32'b00000000000000000000000000010000);
  assign _zz_481_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000001100)) == (32'b00000000000000000000000000000100));
  assign _zz_482_ = ((decode_INSTRUCTION & (32'b00000000000000000000000000101000)) == (32'b00000000000000000000000000000000));
  ...
  assign _zz_488_ = (32'b00000000000000000000000001110000);
  assign _zz_489_ = (decode_INSTRUCTION & (32'b00000000000000000000000000100000));
  ...
  assign _zz_494_ = {((decode_INSTRUCTION & _zz_498_) == (32'b00000000000000000010000000000000)),((decode_INSTRUCTION & _zz_499_) == (32'b00000000000000000001000000000000))};
  assign _zz_495_ = (2'b00);
  assign _zz_496_ = ((decode_INSTRUCTION & (32'b00000000000000000101000001001000)) == (32'b00000000000000000001000000001000));
  assign _zz_497_ = (1'b0);
  assign _zz_498_ = (32'b00000000000000000010000000010000);
  assign _zz_499_ = (32'b00000000000000000101000000000000);
  ...
  assign _zz_137_ = {({(_zz_334_ == _zz_335_),(_zz_336_ == _zz_337_)} != (2'b00)),{((_zz_338_ == _zz_339_) != (1'b0)),{(_zz_340_ != (1'b0)),{(_zz_341_ != _zz_342_),{_zz_343_,{_zz_344_,_zz_345_}}}}}};
  ...
  assign _zz_144_ = _zz_137_[12 : 12];
  assign _zz_80_ = _zz_144_;
  assign _zz_145_ = _zz_137_[14 : 13];
...
module Briey (
  ...
  wire  axi_apbAVLBridge_io_apb_PREADY;
  wire [31:0] axi_apbAVLBridge_io_apb_PRDATA;
  ...
  Apb3Router apb3Router_1_ ( 
    ...
    .io_outputs_4_PREADY(axi_apbPrinceBridge_io_apb_PREADY),
    .io_outputs_4_PWRITE(apb3Router_1__io_outputs_4_PWRITE),
    .io_outputs_4_PWDATA(apb3Router_1__io_outputs_4_PWDATA),
    .io_outputs_4_PRDATA(axi_apbPrinceBridge_io_apb_PRDATA),
